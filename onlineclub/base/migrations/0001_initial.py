# Generated by Django 3.2.5 on 2021-08-12 10:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_staff', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='base.authuser')),
            ],
        ),
        migrations.CreateModel(
            name='Posts',
            fields=[
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='base.authuser')),
            ],
        ),
        migrations.AddField(
            model_name='clubs',
            name='club_type',
            field=models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='base.clubtypes'),
        ),
        migrations.AddField(
            model_name='clubs',
            name='user',
